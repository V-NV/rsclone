const cssTask01 = `
  ...
  <h2>Instructions</h2><p>Copy the code into the editor. Try substituting different values to see how the editor works. Tests expect a full copy of the code below.</p>
