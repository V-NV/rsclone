const htmlTask06 = `
  ...
  <p>t is broken down into small blocks of meaning. Not only is it more comfortable to read, but you can quickly find the information you need in a large text.</p>
  
  <p>Paragraphs are created using the paired <code>&lt;p&gt;</code> tag with a small amount of text in the body. For example:</p>
