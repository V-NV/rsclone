const htmlTask04 = `
  ...
  <p>The <code>&lt;ul&gt;</code> tag is used to define the list, and this one indicates that it&#39;s <em>a bulleted</em> list. Inside are the <code class="prettyprint">&lt;li&gt;</code> tags that define the elements of our list.</p>
  
  <p>This kind of nesting resembles a tree, there&#39;s a treetop (the <code>&lt;ul&gt;</code> tag) and leaves (the <code>&lt;li&gt;</code> tags)</p>
  ...
  <p>Interestingly a tag with other tags inside is also called <em>a wrapper</em></p>
  
  <hr>
  
  <p>The tree can grow even further. The lessons about lists will show you that other lists can be placed inside list elements, and then lists can be placed inside those lists, and so on and so forth.</p>
  
  <p>But there are exceptions. You can&#39;t put paragraphs within paragraphs in HTML. The example below would be incorrect:</p>
