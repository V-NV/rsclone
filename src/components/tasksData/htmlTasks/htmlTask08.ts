const htmlTask08 = `
  ...
  <p>Such logical divisions into headings allow you to navigate faster in the document and find the part you need.</p>
  
  <p>To create titles used 6 paired tags: <code>&lt;h1&gt;</code>, <code>&lt;h2&gt;</code>, <code>&lt;h3&gt;</code>, <code>&lt;h4&gt;</code>, <code>&lt;h5&gt;</code>, <code>&lt;h6&gt;</code>, where <code>&lt;h1&gt;</code> — title of the first level, the most important and describes the main subject of the text, and <code>&lt;h6&gt;</code> — the title of the lowest level.</p>
  ...
  <p>Each lower level heading is a subsection of a higher level heading. This is very similar to the table of contents of any book, the structure of which might look like this:</p>
